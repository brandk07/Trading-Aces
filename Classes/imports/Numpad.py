...
class Numpad:
    ...
    def draw(self,screen,coords,wh,extratext,mousebuttons,maxvalue):
        ...
        extratext = s_render(f"{int(self.numstr):,.0f} "+extratext,45,(255,255,255),font='cry')
        topheight = extratext.get_height()*1.5
        gfxdraw.box(screen,pygame.Rect((coords[0]+5,coords[1]+5),(wh[0]-10,topheight)),(30,30,30))

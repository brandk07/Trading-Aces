...
class StockAsset(Asset):
    def __init__(self,stockobj,creationdate,ogvalue,quantity,dividendTotal=0) -> None:
    ...
    def savingInputs(self):
        return (self.stockobj.name,self.date,float(self.ogvalue),self.quantity,self.totalDividends)

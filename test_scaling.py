#!/usr/bin/env python3
"""
Quick test for the resolution scaling system
"""
import sys
import os
...
def test_scaling():
    ...
    pygame.display.set_caption("Resolution Scaling Test")
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT or (event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE):
                ...
                scaled_pos = scale_mouse_pos(raw_pos)
                print(f"Raw mouse: {raw_pos}, Scaled: {scaled_pos}")
        ...
        scaled_mouse = scale_mouse_pos(raw_mouse)
        mouse_text = font.render(f"Mouse: Raw {raw_mouse}, Scaled {scaled_mouse}", True, (255, 255, 255))
